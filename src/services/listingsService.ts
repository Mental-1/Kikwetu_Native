import { ListingAttributes } from "@/src/types/categoryAttributes";
...
export interface CreateListingData
  extends Omit<Listing, "id" | "user_id" | "created_at" | "updated_at"> {}
...
export async function getUserListings(
  ...
  return apiClient.get<Listing[]>("/listings/my-listings", {
    ...filters,
    page,
  }) as unknown as PaginatedResponse<Listing>;
}
...
export async function deleteListingImage(
  ...
  return apiClient.delete<void>(
    `/listings/${listingId}/images?imageUrl=${imageUrl}`,
  );
}
