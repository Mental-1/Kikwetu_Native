...
const Home = (props: Props) => {
    ...
    const handleListingFavoritePress = useCallback(
                    ...
                    <View style={styles.headerRight}>
                        ...
                        >
                            <View
                                style={[
                                    styles.avatar,
                                    user && styles.authenticatedAvatar,
                                ]}
                            >
                                {user
                                    ? (
