...
const ListingCard: React.FC<ListingCardProps> = ({
  ...
  if (viewMode === 'list') {
    return (
      <Pressable style={styles.listCard} onPress={handlePress}>
        {/* Image on the left */}
        <View style={styles.listImageContainer}>
          <Image source={{ uri: image }} style={styles.listImage} contentFit="cover" />
        </View>
        ...
        <View style={styles.listContent}>
          ...
          <View style={styles.listTitleRow}>
            ...
            <Pressable style={styles.listFavoriteButton} onPress={handleFavoritePress}>
              <Ionicons
